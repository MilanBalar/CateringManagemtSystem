...
beer means===login page
reservation means====register page
	  ...
	  <div id="page">
		   ...
		   <div id="body">
				...
				<div class="slider">
			       <ul>
					   ...
					   <li>
							 <a href="index.jsp" > <img src="images/barbeque.jpg" width="640" height="331" alt="Steak House" title="Steak House" ></a>
					   </li>
				   </ul>
			    </div>
			    ...
			    <ul id="featured">
		            <li class="first"><a href="food"><img src="images/food-menu.jpg" width="470px" height="237" alt="steak house" title="steak house"></a><li>
					<li><a href="beer"><img src="images/beer.jpg" width="460px" height="237" alt="steak house" title="steak house"></a><li>
				</ul>
		   ...
		   <div id="footer">
                <ul>
					...
					<li class="last">
				        <span> &copy; copyright 2020 &copy;. All rights reserved.</span> 	
					</li>
				</ul>		       
